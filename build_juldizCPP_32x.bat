...
set OUTPUTPATHFILE="E:\Projects\Build\Juldiz\GeoZones_32x\GeoZones.dll"
...
set OUTPUTPATH="E:\Projects\Build\Juldiz\GeoZones_32x"
call "c:\Program Files (x86)\MSBuild\14.0\Bin\MsBuild.exe" %SLN% /t:Build /p:Configuration=Release /p:Platform=win32 /p:OutDir=%OUTPUTPATH%
